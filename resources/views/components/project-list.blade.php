...
@endcan
                ...
                <footer class="p-4 bg-slate-50/50 border-t border-slate-100">
                    <form action="{{ route('tasks.store', $project->id) }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap md:flex-nowrap items-center gap-3">
                        ...
                        <input type="text" name="title" placeholder="Add a task..." required class="flex-1 min-w-[200px] bg-white border-slate-200 rounded-xl text-sm px-4 py-2 border outline-none focus:ring-2 focus:ring-indigo-500/20">
                        ...
                        <button type="submit" class="bg-slate-900 text-white px-6 py-2 rounded-xl text-xs font-bold hover:bg-indigo-600 transition-all shadow-sm">Add</button>
                    </form>
                </footer>
            </section>
        </div>
